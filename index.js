...
const pizza = require("./src/router/pizza.router"); //arquivo de rota de pizza
...
app.use("/pizza", pizza); //chamando as rotas de pizza
...
app.get("/", (req,res) => {
    res.send({
        message: "Bem vindo à nossa Pizzaria API"
    });
})
